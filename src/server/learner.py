...
class learner:
	...
	def highervals1(self, hand):
		...
		for currcarda in hand:
			...
			for carda in deck:
				...
				#TODO here's where we should check the likelihood of winning wiht this val
				tempval = hands.handval(testhand)
				if tempval > currval:
					highercount += 1
					...
					for carda in deck:
						...
						for cardb in bdeck:
							...
							for cardc in bdeck:
								...
								#TODO here's where we should check the likelihood of winning with this val
								tempval = hands.handval(testhand)
								if tempval > currval:
									highercount += 1
								elif currval > tempval: 
	...
	def chooseswap(self):
		...
		self.highervals1(list(self.hand))
		print "entering highervals2:"
		self.highervals2(list(self.hand))
		print "entering highervals3:"
		self.highervals3(list(self.hand))
